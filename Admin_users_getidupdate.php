...
<head>
    ...
    if(isset($_SESSION['adminloginusername']))
    {
        ...
        {
            $_SESSION['Uid']=$_POST['Getidforupdate'];
            header("location:Admin_users_update.php");
        }
    }
    else{
...
<div class="login_Container">
    <div >
        <h1 style="margin-top: 5%">Enter User Id For Update</h1>
    </div>
    <br>
    <form action="Admin_users_getidupdate.php" method="POST">
        <div>
